...
public class Cappuccino  extends CupSize{
	Cappuccino()
	{
		...
		if (getChoice() == 2)
		{
			...
			System.out.println("Your order is Cappuccino without any additions");
	...
	static void addi(int i)
	{
		...
		{
			System.out.println("Thank you for palcing your order..........");
			System.out.println("Your order is Cappuccino with Milk");
			System.out.println("Have a nice day :)");
		}
		else
		{
	...
	{
		System.out.println("Thank you for palcing your order..........");
		System.out.println("Your order is Cappuccino with Milk and Suger");
		System.out.println("Have a nice day :)");
	}
}
